...
class AuthController extends Controller
{
     ...
     *                     description="User roles. Available roles: ROLE_USER (regular user), ROLE_ADMIN (administrator), ROLE_ESTABLISHMENT (institution user)",
     *                     example={"ROLE_USER"}
     *                 )
     *             ),
     ...
     *                 type="array",
     *                 @OA\Items(ref="#/components/schemas/UserRole"),
     *                 description="User roles determining access permissions",
     *                 example={"ROLE_USER"}
     *             ),
